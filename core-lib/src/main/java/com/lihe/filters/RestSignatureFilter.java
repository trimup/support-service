...
public class RestSignatureFilter extends OncePerRequestFilter {
    ...
    @Value("${ignore_ips:127.0.0.1, 192.168., 120.55.120.173, 10.174.39.54, 121.41.106.210, 10.168.234.100,121.41.8.132,10.117.183.125}")
    private String[] ignore_ips =
        new String[] {"127.0.0.1", "192.168.", "120.55.120.173", "10.174.39.54", "121.41.106.210",
            "10.168.234.100", "121.41.8.132", "10.117.183.125"};
